...
public class GAConfig {
    ...
    public GAConfig() {
        ...
        this.elitismCount = 10;           // Number of top schedules passed unchanged to the next generation
    ...
    public GAConfig(int maxGenerations, int populationSize, int tournamentSize,
                    int elitismCount, double initialMutationRate, double mutationImpactRatio, double stagnationToleranceRatio) {
