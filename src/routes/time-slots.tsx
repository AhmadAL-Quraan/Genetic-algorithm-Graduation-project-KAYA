...
export const Route = createFileRoute("/time-slots")({ component: TimeSlotsPage });
...
function MethodSection({
  ...
  // group same-window-but-different-day rows for display
  return (
...
function TimeSlotsPage() {
  ...
  const deleteAll = TimeSlots.useDeleteAll();
    ...
    <div className="space-y-5">
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This removes all windows permanently.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
      ...
      {METHOD_META.map(({ method, label, color, bg }) => (
        <MethodSection
          ...
          slots={
            list.data?.filter(
              (t) => t.teachingMethod === method && t.durationMinutes != null,
            ) ?? []
          }
        />
      ))}
